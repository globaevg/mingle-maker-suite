...
function RouteState({ title, message, action }: { title: string; message?: string; action?: ReactNode }) {
  return (
...
export function GalleryModeration({ eventId }: { eventId: string }) {
  const id = eventId;
...
function Grid({ items, actions }: { items: any[]; actions: (p: any) => ReactNode }) {
